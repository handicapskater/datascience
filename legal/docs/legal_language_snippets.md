...
These snippets are a tracked drafting copy of the filed-output snippets at:

`legal/cases/25-7526/outputs/exhibit_a_filed_2026-06-04/legal_language_snippets.md`

This file is documentation only. It is not a filed artifact and does not replace the locked filed output.
